...
html_content = f"<html><head><title>Pump Control Status</title></head>\
        <body><center><h1>Pump Control Status @ {tnow} </h1><h2>Voltage</h2><p>Battery voltage =  {volts}  </p>\
        <h2>CPU Temperature</h2><p>CPU Temperature = {ctemp}</p>\
        <h2>External Temperature</h2><p>External Temperature = {etemp}</p>\
        <h2>Internal Temperature</h2><p>Internal Temperature = {itemp}</p></center></body></html>"
