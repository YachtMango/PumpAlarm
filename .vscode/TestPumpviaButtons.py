...
#
InputA = 4  # 3.5 mins  = 210
InputB = 8  # 7.5 mins  = 450
...
def LCD():
    ...
    tfont = ImageFont.truetype(UserFont, 20)
    colour = (255, 181, 86)
    ...
    while True:
        ...
        image = Image.open("/home/pi/PumpImage.jpg")
...
def Buttons():
    while True:          
        if ahm.input.one.is_on(): 
            ...
            with open('/home/pi/pumplogfile.txt','a') as l:
